...
// Define the maximum number of concurrent sessions
  ...
  // Tune max concurrent FTP sessions by platform. Keep conservative values for
  // constrained devices. Users can still override by defining FTP_MAX_SESSIONS
  // before including this header or by passing the parameter to the constructor.
  #if defined(ESP32) || defined(ARDUINO_ARCH_ESP32)
    #define FTP_MAX_SESSIONS 4
  #elif defined(ESP8266) || defined(ARDUINO_ARCH_ESP8266)
    #define FTP_MAX_SESSIONS 2
  #elif defined(__AVR__)
    #define FTP_MAX_SESSIONS 1
  #elif defined(ARDUINO_ARCH_STM32)
    #define FTP_MAX_SESSIONS 3
